/* tslint:disable */
/* eslint-disable */
export function deriveKaspaWallet(phrase: string): any;
...
export interface InitOutput {
  ...
  readonly deriveKaspaWallet: (a: number, b: number, c: number) => void;
  ...
  readonly validateKaspaAddress: (a: number, b: number) => number;
