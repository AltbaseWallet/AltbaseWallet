...
const createBitcoinForkAdapter = ({ coin, rpcUrl, rpcUser, rpcPassword, readProfile = 'auto', timeoutMs, indexer }) => {
  ...
  const rpc = createBitcoinRpc({ url: rpcUrl, user: rpcUser, password: rpcPassword, timeoutMs })
